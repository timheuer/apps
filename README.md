...
| **[RoomBoard](https://timheuer.github.io/apps/roomboard/)** | Household chore coordination for families and roommates, with shared tasks, fairness tracking, and privacy-first account management. | [Request Support](https://github.com/timheuer/apps/issues/new?template=bug_report.yml&app=RoomBoard) |
...
| **[Crown Climb](https://timheuer.github.io/crownclimb)** | A single-player offline card game of rank and strategy where you climb the social ladder from peasant to king. | [Request Support](https://github.com/timheuer/apps/issues/new?template=bug_report.yml&app=Crown+Climb) |
| **[MyWattz](https://timheuer.github.io/wattz)** | Connect to your Bluetooth cycling sensors and view live power, cadence, and heart rate metrics on iPhone. | [Request Support](https://github.com/timheuer/apps/issues/new?template=bug_report.yml&app=MyWattz) |
| **[PC Screenshotter](https://timheuer.github.io/screenshotter)** | Capture screenshots on your Windows PC remotely from your iPhone with a private, local-first setup. | [Request Support](https://github.com/timheuer/apps/issues/new?template=bug_report.yml&app=PC+Screenshotter) |
